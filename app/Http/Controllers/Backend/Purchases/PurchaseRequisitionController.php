...
class PurchaseRequisitionController extends Controller
{
    ...
    public function __construct(PurchaseRequisitionInterface $interface){
    ...
    public function offerPriceRequest($id){
        return $this->interface->offerPriceRequest($id);
    }

    public function showOfferPriceRequest($id){
        return $this->interface->showOfferPriceRequest($id);
    }
