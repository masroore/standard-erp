...
document.getElementsByClassName('additem')[0].addEventListener('click', function() {
  ...
  '<td class="delete-item-row">'+
      ...
      '</ul>'+
    '</td>'+
    '<td class="description"><input type="text" class="form-control  form-control-sm"> </td>'+
    '<td class="rate">'+
        '<input type="text" class="form-control  form-control-sm">'+
   ' </td>'+
    '<td class="text-right qty"><input type="text" class="form-control  form-control-sm"></td>'+
