            ...
            <div class="widget-content widget-content-area">
                <nav class="breadcrumb-one p-3" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="javascript:void(0);"> @lang('site.parent_company')</a></li>
                        <li class="breadcrumb-item active" aria-current="page"><span>@lang('site.parent_company_list')</span></li>
...
@include('backend.parentCompany.create')
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                              ...
                              @include('backend.parentCompany.edit')


                                <form action="{{route('dashboard.parentCompany.destroy', $row->id)}}" method="POST" style="display:inline-block">
                                    @csrf
                                 @method('delete')
