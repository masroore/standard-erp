    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel{{$row->id}}"> @lang('site.edit_parent_company')</h5>
            ...
            <form action="{{route('dashboard.parentCompany.update', $row->id)}}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('put')
