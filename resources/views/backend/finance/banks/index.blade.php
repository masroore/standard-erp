...
<li class="breadcrumb-item"><a href="javascript:void(0);">  @lang('site.banks')</a></li>
<li class="breadcrumb-item active" aria-current="page"><span>  @lang('site.all_banks')</span></li>

@endcomponent
@include('backend.partials._errors')

@include('backend.finance.banks.create')
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                              ...
                              @include('backend.finance.banks.edit')


                              {{-- end of edit --}}
                                <form action="{{route('dashboard.finance.banks.destroy', $row->id)}}" method="POST" style="display:inline-block">
                                    @csrf
                                 @method('delete')
...
@include('backend.finance.banks.validate')
@endpush
