...
<div class="modal fade " id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" >
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            ...
            <form action="{{route('dashboard.finance.transactions.save.payment-to-supplier')}}" method="POST" name="transaction" enctype="multipart/form-data">
                @csrf
            ...
            <div class="modal-body">
                ...
                <div class="form-group col-md-4">
                    ...
                    <input  type="text" name="code" value="{{ transactionCode() }}" class="form-control" readonly>
                ...
                <div class="form-group col-md-4">
                    ...
                    <input id="basicFlatpickr" name="created_at" class="form-control flatpickr flatpickr-input active" type="text" placeholder="@lang('site.select_date')" required>
                </div>
                <div class="form-group col-md-4">
                ...
                <div class="form-group col-md-4">
                    ...
                    <input type="number" id="amountToPay" name="amount" placeholder="0.00" class="form-control" required>
                </div>

                {{-- <div class="form-group">
                    <label> @lang('site.remaining_amount') </label>
                    <input type="number" id="reminingAmount" name="remaining_amount" value="" class="form-control" readonly>
                </div> --}}
                ...
                <div class="option-visible row m-2">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <select class="form-control basic" name="bank_id">
                    ...
                    <div class="form-group col-md-3">
                        <label> @lang('site.document_code') </label>
