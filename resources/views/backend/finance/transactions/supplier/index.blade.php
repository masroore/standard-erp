...
<li class="breadcrumb-item active" aria-current="page"><span>  @lang('site.payment_to_supplier')</span></li>

@endcomponent

@include('backend.partials._errors')

@include('backend.finance.transactions.supplier.create')
            ...
            <table id="zero-config" class="table dt-table-hover" style="width:100%">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="sorting_1 sorting_2">
                            <div class="d-flex">
                                <p class="align-self-center mb-0"> {{ $row->supplier->company_name }}</p>
                            </div>
                        </td>
                        ...
                        <td>
                              ...
                              @include('backend.finance.transactions.supplier.edit')
