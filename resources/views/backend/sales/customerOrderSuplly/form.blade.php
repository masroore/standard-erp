        ...
        <div class="invoice-detail-title">
            <h4 class="font-weight-bold"> @lang('site.add_os_customer')</h4>
            <a href="{{ route('dashboard.purchase-orders.index') }}" class="btn btn-primary float-right"><i class="fa fa-list"></i> @lang('site.all_os_customers')</a>
