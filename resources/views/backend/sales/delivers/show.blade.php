...
@component('backend.partials._pagebar')
    ...
    <li class="breadcrumb-item active" aria-current="page"><span>@lang('site.show_deliver')</span></li>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8 text-sm-right ">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-7 text-left"><p> <strong>{{ $row->reference_no }}</strong> </p></div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-1">:</div>
                                                        <div class="col-md-7 text-left"><p> <strong>{{ $row->store->title_ar ?? '' }}</strong> </p></div>
                                                    </div>

                                                    <div class="row">
                                                        <div class="col-md-3">
                                                            <p class="align-self-center"><span class="align-self-center"> @lang('site.customer') </p>
                                                        </div>
                                                        <div class="col-md-1">:</div>
                                                        <div class="col-md-7 text-left"><p> <strong>{{ $row->customer->company_name }}</strong> </p></div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-1">:</div>
                                                        <div class="col-md-7 text-left"><p> <strong>{{ $row->date }}</strong> </p></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="invoice-actions-btn">
                        ...
                        <div class="invoice-action-btn">
                            ...
                            <div class="row">
                                ...
                                @if ($row->document)
                                <div class="col-xl-12 col-md-3 col-sm-6">
                                    <a href="{{ asset('public/uploads/sales/delivers/'.$row->document) }}" class="btn btn-success btn-download" download="">@lang('site.document')</a>
                                </div>
                                @endif
                            </div>
                        </div>
