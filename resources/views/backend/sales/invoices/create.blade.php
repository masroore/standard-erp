                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td class="description">
                                                            <input type="hidden" id="item_id" name="item_id" class=" form-control form-control-sm" placeholder="Item Description" autocomplete="off">
                                                        ...
                                                        <td class="text-right qty"><input type="text" class="form-control form-control-sm" placeholder="tax"></td>
                                                        <td class="text-right qty"><input type="text" class="form-control form-control-sm" placeholder="discoind"></td>
