                        ...
                        <div class="invoice-content">
                            ...
                            <div class="invoice-detail-body">
                                ...
                                <div class="invoice-detail-items">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="description">
                                                        <input  type="hidden" name="item_id" class=" form-control form-control-sm search item_id1" placeholder="Item Description" autocomplete="off">

                                                        <input type="text" id="1" class=" form-control form-control-sm search title1" placeholder="Item Description" autocomplete="off">
                                                    ...
                                                    <td class="text-right " style="width:220px;"><input type="text"  class="form-control form-control-sm qty1"  placeholder="Quantity"></td>
                                                    <td class="description ">
                                                        <select class="form-control form-control-sm  tax1" id="" name="tax" >
                                                    ...
                                                    <td class="description">
                                                        <div class="input-group mb-3">
                                                            <input type="text" id="" class="form-control form-control-sm disc1" placeholder="discoind">
                                                            <div class="input-group-prepend form-controlsm">
                                                                <div class="input-group-text" style="padding: 0;">
                                                                  <select class="form-control form-control-sm disc_type1" id="" name="disc_type" style="height: 100%;border: 0;width: 100%;padding: 0;">
                                                                      <option>%</option>
                                                                      <option>num</option>
                                                    ...
                                                    <input type="hidden" id="" class="form-control form-control-sm sale_price1" placeholder="">

                                                    <td class="text-right description">
                                                        <span class="editable-amount"><span class="currency">$</span> <span class="amount1" ></span>
                                                        <hr>
                                                        <div>
                                    ...
                                    <button class="btn btn-secondary additem btn-sm" id="1">Add Item</button>
...
$(document).ready(function(){
        ...
        $('.additem').on('click', function() {
            ...
            $html = `<tr>
                                ...
                                <td class="description">
                                    <input type="hidden" name="item_id"  class=" form-control form-control-sm search item_id`+id+`" placeholder="Item Description" autocomplete="off">

                                    <input type="text" id="`+id+`" class=" form-control form-control-sm search title`+id+`" placeholder="Item Description" autocomplete="off">
                                ...
                                <td class="text-right " style="width:220px;"><input type="text"  id=""  class="form-control form-control-sm qty`+id+`"  placeholder="Quantity"></td>
                                <td class="description ">
                                    <select class="form-control form-control-sm tax`+id+`" id="" name="tax" >
                                        <option  value="0">select tax</option>
                                        @foreach ($taxes as $tax)
                                        <option value="{{ $tax->rate }}" >{{$tax->name . '('.$tax->rate .'%)'}}</option>
                                        @endforeach
                                ...
                                <td class="description">
                                    <div class="input-group mb-3">
                                        <input type="text"  class="form-control form-control-sm disc`+id+`" placeholder="discoind">
                                        <div class="input-group-prepend form-controlsm">
                                            <div class="input-group-text" style="padding: 0;">
                                                <select class="form-control form-control-sm disc_type`+id+`" id="" name="disc_type" style="height: 100%;border: 0;width: 100%;padding: 0;">
                                                    <option>%</option>
                                                    <option>num</option>
                                ...
                                <input type="hidden" id="" class="form-control form-control-sm sale_price`+id+`" placeholder="">

                                <td class="text-right description">
                                    <span class="editable-amount"><span class="currency">$</span> <span class="amount`+id+`" ></span>
                                    <hr>
                                    <div>
