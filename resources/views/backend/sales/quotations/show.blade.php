...
@component('backend.partials._pagebar')
    ...
    <li class="breadcrumb-item active" aria-current="page"><span>@lang('site.show_quotation')</span></li>
                                        ...
                                        <div class="inv--head-section inv--detail-section">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6 text-sm-right">
                                                    <p class="inv-list-number"><span class="inv-title"> @lang('site.quotation') : </span> <span class="inv-number">#{{ $row->reference_no }}</span></p>
                                                </div>
                                                ...
                                                <div class="col-sm-6 align-self-center mt-3 text-sm-right">
                                                    <p class="inv-created-date"><span class="inv-title">@lang('site.from_date') : </span> <span class="inv-date">{{ $row->start_date }}</span></p>
                                                    <p class="inv-due-date"><span class="inv-title">@lang('site.to_date') : </span> <span class="inv-date">{{ $row->expired_date }}</span></p>
                                                </div>
                                        ...
                                        <div class="inv--detail-section inv--customer-detail-section">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xl-8 col-lg-7 col-md-6 col-sm-4 align-self-center">
                                                    <p class="inv-to">@lang('site.quotation') @lang('site.to') : </p>
                                                </div>
                                                ...
                                                <div class="col-xl-8 col-lg-7 col-md-6 col-sm-4">
                                                    <p class="inv-customer-name">{{ $row->customer->company_name }}</p>
                                                    <p class="inv-street-addr">{{ $row->customer->address }}</p>
                                                    <p class="inv-email-address">{{ $row->customer->email }}</p>
                                                    <p class="inv-email-address">{{ $row->customer->phone }}</p>
                                                </div>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @foreach ($row->quotationItem as $index => $item)
                                                        <tr>
                                                            <td>{{ $index+1 }}</td>
                                                            
                                                            <td>{{ $lang == 'ar' ? $item->items->title_ar : $item->items->title_en}}</td>
