              ...
              <div class="row">
                    <div class="col-md-8">
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-2"> : </div>
                          <div class="col-md-5">{{$row->title_ar}} <br> {{$row->title_en}}</div>
                        </div>
                        <hr>
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-2"> : </div>
                          <div class="col-md-5">{{$row->category->title_ar }} <br> {{$row->category->title_en }}</div>
                        </div>
                        <hr>
                        <div class="row">
                          ...
                          <div class="col-md-5">{{$row->brand->title_ar }} <br> {{$row->brand->title_en }}</div>
                          @else 
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2"> : </div>
                            <div class="col-md-5">{{  userName ($row->created_by)}} </div>
                        </div>
                          <hr>
