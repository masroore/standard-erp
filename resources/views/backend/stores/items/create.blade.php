...
@section('title')
        {{ $lang == 'ar' ? ' اضافة صنف جديد' : 'Add New Item ' }}
@endsection
 @section('modelTitlie')
            ...
            <div class="widget-content widget-content-area">
                <nav class="breadcrumb-one p-3" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><span>{{$lang == 'ar' ? '  اضافة صنف جديد ' : ' Add New Item'}}</span></li>
            ...
            <div class="widget-header">
                <div class="row">
                    <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                        <h4>{{$lang == 'ar' ? 'الرجاء ادخال البيانات الاتية' : ' Please Fill Data '}}</h4>
                    </div>                                                                        
                </div>
            </div>
