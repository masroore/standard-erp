            ...
            <div class="widget-content widget-content-area">
                <nav class="breadcrumb-one p-3" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="javascript:void(0);"> {{ $lang == 'ar' ? ' الاصناف ' : 'Items ' }}</a></li>
                        <li class="breadcrumb-item active" aria-current="page"><span>{{$lang == 'ar' ? 'قائمة  الاصناف ' : 'Items List'}}</span></li>
...
<div class="text-center">
    <a href="{{route('dashboard.items.create')}}" class="btn btn-primary mb-2 mr-2" >
