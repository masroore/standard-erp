            ...
            <div class="widget-content widget-content-area">
                <nav class="breadcrumb-one p-3" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{route('dashboard.categories.index')}}">@lang('site.price_list')</a></li>
    ...
    <div id="flFormsGrid" class="col-lg-8 layout-spacing m-auto" >
        <div class="statbox widget box box-shadow">
            ...
            <div class="widget-content widget-content-area p-3">
                <form action="{{ route('dashboard.priceList.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
