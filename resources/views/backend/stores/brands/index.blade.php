            ...
            <div class="widget-content widget-content-area">
                <nav class="breadcrumb-one p-3" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="javascript:void(0);"> {{ $lang == 'ar' ? ' العلامات التجارية' : 'Brands ' }}</a></li>
                        <li class="breadcrumb-item active" aria-current="page"><span>{{$lang == 'ar' ? 'قائمة العلامات التجارية ' : 'Brands List'}}</span></li>
...
@include('backend.stores.brands.create')
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                              ...
                              @include('backend.stores.brands.edit')


                              {{-- end of edit --}}
                                <form action="{{route('dashboard.stores.brands.destroy', $row->id)}}" method="POST" style="display:inline-block">
                                    @csrf
                                 @method('delete')
...
@include('backend.stores.brands.validate')
@endpush
