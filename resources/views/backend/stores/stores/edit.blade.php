    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel_{{$row->id}}"> {{ $lang == 'ar' ? '  تعديل العلامة التجارية ' : 'Edit  Brand ' }}</h5>
            ...
            <form action="{{route('dashboard.stores.stores.update', $row->id)}}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('put')
