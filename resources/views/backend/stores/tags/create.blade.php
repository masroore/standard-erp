    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">@lang('site.add_new_tag')</h5>
            ...
            <form action="{{route('dashboard.stores.tags.store')}}" method="POST" name="tag" enctype="multipart/form-data">
                @csrf
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <input  type="text" name="title" placeholder="@lang('site.title')" class="form-control">
