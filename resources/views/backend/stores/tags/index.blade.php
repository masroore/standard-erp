            ...
            <div class="widget-content widget-content-area">
                <nav class="breadcrumb-one p-3" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="javascript:void(0);">  @lang('site.tags')</a></li>
                        <li class="breadcrumb-item active" aria-current="page"><span> @lang('site.tag_list')</span></li>
...
@include('backend.stores.tags.create')
                    ...
                    <tr>
                        ...
                        <td class="sorting_1 sorting_2">
                            <div class="d-flex">
                                ...
                                <p class="align-self-center mb-0 admin-name"> {{$row->title}} </p>
                            </div>
                        </td>
                        ...
                        <td>
                              ...
                              @include('backend.stores.tags.edit')
