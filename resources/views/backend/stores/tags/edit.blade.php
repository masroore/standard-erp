<button type="button" class="btn btn-warning" data-toggle="modal" data-target="#exampleModal{{$row->id}}" title=" @lang('site.edit')">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel{{$row->id}}">  @lang('site.edit_tag')</h5>
            ...
            <form action="{{route('dashboard.stores.tags.update', $row->id)}}" name="tag{{ $row->id }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('put')
