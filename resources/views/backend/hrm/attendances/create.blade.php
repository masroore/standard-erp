    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel"> @lang('site.add_new_attendance')</h5>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-6">
                        ...
                        <input type="time"  name="check_in" value="" class="form-control " type="text" placeholder="Select Date.." >
                    ...
                    <div class="form-group col-6">
                        ...
                        <input type="time"  name="check_out" value="" class="form-control " type="text" placeholder="Select Date.." >
