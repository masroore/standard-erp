            ...
            <div class="widget-content widget-content-area">
                <nav class="breadcrumb-one p-3" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="javascript:void(0);"> @lang('site.departments')</a></li>
                        <li class="breadcrumb-item active" aria-current="page"><span>@lang('site.departments_list')</span></li>
...
@include('backend.hrm.departments.create')
                    ...
                    <tr>
                        ...
                        <td class="sorting_1 sorting_2">
                            <div class="d-flex">
                                ...
                                <p class="align-self-center mb-0 admin-name"> {{$row->name_en}} </p>
                            </div>
                        </td>
                        <td class="sorting_1 sorting_2">
                            <div class="d-flex">

                                <p class="align-self-center mb-0 admin-name"> {{$row->name_ar}} </p>
                            </div>
                        </td>
                        ...
                        <td>
                              ...
                              @include('backend.hrm.departments.edit')


                                <form action="{{route('dashboard.departments.destroy', $row->id)}}" method="POST" style="display:inline-block">
                                    @csrf
                                 @method('delete')
