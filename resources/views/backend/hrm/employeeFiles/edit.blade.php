    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel{{$row->id}}"> @lang('site.edit_employeeFile')</h5>
            ...
            <form action="{{route('dashboard.employeeFiles.update', $row->id)}}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('put')
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-6 m-auto">
                        ...
                        <label for="percent">@lang('site.file')</label>
