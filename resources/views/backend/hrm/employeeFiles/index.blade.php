            ...
            <div class="widget-content widget-content-area">
                <nav class="breadcrumb-one p-3" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="javascript:void(0);"> @lang('site.employeeFiles')</a></li>
                        <li class="breadcrumb-item active" aria-current="page"><span>@lang('site.employeeFiles_list')</span></li>
...
@include('backend.hrm.employeeFiles.create')
            ...
            <table id="zero-config" class="table dt-table-hover" style="width:100%">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="sorting_1 sorting_2">
                            <div class="d-flex">
                            <a href="{{ asset('public/'.$row->file) }}" target="_blank" rel="noopener noreferrer">
                                <span class="badge badge-success"> @lang('site.file') <i class="fa fa-check" aria-hidden="true"></i> </span>
                            </a>
                            </div>
                        </td>
                        ...
                        <td>
                              ...
                              @include('backend.hrm.employeeFiles.edit')


                                <form action="{{route('dashboard.employeeFiles.destroy', $row->id)}}" method="POST" style="display:inline-block">
                                    @csrf
                                 @method('delete')
