    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel"> @lang('site.add_new_employeeFile')</h5>
            ...
            <form action="{{route('dashboard.employeeFiles.store')}}" method="POST" enctype="multipart/form-data">
                @csrf
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-12">
                        ...
                        <label for="employee_id">@lang('site.employee')</label>
