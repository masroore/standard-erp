            ...
            <div class="user-profile layout-spacing">
                <div class="widget-content widget-content-area">
                    <div class="d-flex justify-content-between">
                        <h3 class="">Info</h3>
                        <a href="{{route('dashboard.employees.edit',$row->id) }}" class="mt-2 edit-profile"> <svg
                    ...
                    <div class="text-center user-info">
                        @if($row->photo != null)
                        <img width="90" height="90" src="{{ asset('public/'.$row->photo) }}" alt="avatar">
                        @else
                        <img alt="avatar" width="90" height="90"  src="{{asset('public/img/avatar.png')}}">
                        @endif
                        <p class="">{{ $row->name }}</p>
                    </div>
                        ...
                        <div class="">
                            <ul class="contacts-block list-unstyled">
                                <li class="contacts-block__item">
                                    ...
                                    </svg>   {{($lang=='ar') ? $row->department_ar : $row->department_en}}
                                </li>
                                <li class="contacts-block__item">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                        fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                ...
                                <li class="contacts-block__item">
                                    <a href="mailto:{{ $row->email }}" style="display: inline-flex;"><svg xmlns="http://www.w3.org/2000/svg" width="24"
