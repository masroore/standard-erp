...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="mb-4 widget-content widget-content-area p-3">
            ...
            <div class="form-group row">
                <label class="col-md-3" for="">@lang('site.tax_client')</label>
                <div class="form-check pl-0 col-md-8">
                    <div class="custom-control custom-checkbox checkbox-info">
            ...
            <div class="form-group row hide-tax">
                ...
                <input type="text" id="tax_id" name="tax_id" class="form-control col-md-8" value="{{ old('tax_id', isset($row) ? $row->tax_id : '')}}"  required>
