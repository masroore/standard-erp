            ...
            <div class="widget-header">
                <div class="row">
                    <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                        <h4> @lang('site.customer_profile') </h4>
                    </div>
                </div>
            </div>
            <div class= "p-3">
                ...
                <div class="col-md-6">
                    <div class="form-row mb-4 widget-content widget-content-area p-3">
                        ...
                        <div class="col-md-12 mt-3">
                            <img width="100%" src="{{asset('public/uploads/customers/photos/'.$row->photo)}}">
                        </div>
                        @endif
                        ...
                        <div class="col-md-12 mt-3">
                           ...
                           <a class="btn btn-primary" href="{{ asset('public/uploads/customers/documents/'.$row->document) }}" download="">@lang('site.download')</a>
