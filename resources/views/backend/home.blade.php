...
<li class="breadcrumb-item"><a href="javascript:void(0);">  @lang('site.dashbord')</a></li>
...
@endsection
@push('css')
<link href="{{ asset('public/backend/crock/plugins/apex/apexcharts.css') }}" rel="stylesheet" type="text/css">
<link href="{{ asset('public/backend/crock/assets/css/dashboard/dash_2.css') }}" rel="stylesheet" type="text/css" />
@endpush
@push('js')
<script src="{{ asset('public/backend/crock/plugins/apex/apexcharts.min.js') }}"></script>
<script src="{{ asset('public/backend/crock/assets/js/dashboard/dash_2.js') }}"></script>
@endpush
