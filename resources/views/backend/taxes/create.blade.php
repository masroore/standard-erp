    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel"> @lang('site.add_new_tax')</h5>
            ...
            <form action="{{route('dashboard.tax.store')}}" method="POST" enctype="multipart/form-data">
                @csrf
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label for="percent">@lang('site.rate') (%)</label>

                    <input type="text" name="rate" placeholder="@lang('site.rate')" class="form-control" required>
