...
@component('backend.partials._pagebar')
    ...
    <li class="breadcrumb-item"><a href="javascript:void(0);">  @lang('site.receives')</a></li>
    <li class="breadcrumb-item active" aria-current="page"><span>@lang('site.receives_list')</span></li>

@endcomponent
<div class="row">
    <div class="col-md-12 text-center">
        <a href="{{ route('dashboard.receives.create') }}" class="btn btn-primary"> <i class="fa fa-plus" aria-hidden="true"></i> @lang('site.add_new') </a>
    </div>
</div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="{{ route('dashboard.receives.show',$row->id ) }}" class="mr-2 btn btn-info btn-sm" title="@lang('site.show')"><i class="fa fa-eye" aria-hidden="true"></i></a>
                            <a href="{{ route('dashboard.receives.edit',$row->id ) }}" class="mr-2 btn btn-warning btn-sm" title="@lang('site.edit')"><i class="fa fa-edit" aria-hidden="true"></i></a>
                            ...
                            <form action="{{route('dashboard.receives.destroy', $row->id)}}" method="POST" style="display:inline-block">
                                @csrf
                                @method('delete')
