        ...
        <div class="invoice-detail-title">
            <h4 class="font-weight-bold"> @lang('site.create_receives')</h4>
        ...
        <div class="invoice-detail-terms">
            ...
            <div class="row">
                ...
                <div class="form-group col-md-4">
                    ...
                    <input type="text" name="reference_no" class="form-control form-control-sm" id="number" value="{{ autoCode('Trans','Rec') }}" >
                </div>
