        ...
        <div class="invoice-detail-title">
            <h4 class="font-weight-bold"> @lang('site.edit_receive')</h4>
            <a href="{{ route('dashboard.receives.index') }}" class="btn btn-primary float-right"><i class="fa fa-list"></i> @lang('site.receives_list')</a>
        ...
        <div class="invoice-detail-terms">
            ...
            <div class="row">
                ...
                <div class="form-group col-md-4">
                    ...
                    <select class="form-control basic" name="supplier_id">
                        @foreach ($suppliers as $supplier)
                            <option value="{{ $supplier->id }}" {{ $supplier->id == $row->supplier_id ? 'selected' : '' }} >{{ $supplier->company_name }}</option>
                        @endforeach
                    </select>
                </div>
                ...
                <div class="form-group col-md-4">
                    ...
                    @if ($row->document)
                    <a href="{{ asset('public/uploads/purchases/receives/'.$row->document) }}">  <i class="fa fa-arrow-down"></i></a>
                    @endif
                </div>
