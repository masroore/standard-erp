...
@section('title')
       @lang('site.edit_purchase_requisitions')
@endsection
@section('modelTitlie')
...
@component('backend.partials._pagebar')
    ...
    <li class="breadcrumb-item active" aria-current="page"><span>@lang('site.edit_purchase_requisitions')</span></li>
            ...
            <div class="row">
                <div class="col-xl-12">
                    ...
                    <div class="invoice-content">
                        ...
                        <form id="form" name="requisitions" action="{{ route('dashboard.purchase-requisitions.update',$row->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('put')
                            <div class="invoice-detail-body">
                                @include('backend.purchases.requisitions.editform')
                                <hr>
