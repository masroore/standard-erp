                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-4 mr-auto">
                                                    ...
                                                    <div class="align-self-center mt-3">
                                                        <p class="inv-email-address"> @lang('site.email') :   {{ setting('company_email') }}</p>
                                                        <p class="inv-street-addr"> @lang('site.address') : {{ setting('company_address') }}</p>
                                                        <p class="inv-email-address"> @lang('site.phone') :   {{ setting('company_phone') }}</p>
                                                    </div>
                                                ...
                                                <div class="col-sm-4 mt-3">
                                                    <p class="inv-email-address"> @lang('site.code') :    {{ $row->id }} </p>
                                                    <p class="inv-email-address"> @lang('site.request_code') : {{ $row->purchRequest->reference_no }} </p>
                                                    <p class="inv-email-address"> @lang('site.date')       : {{ $row->date }} </p>
                                                    <p class="inv-email-address"> @lang('site.created_by') : {{ $row->user->name }} </p>

                                                </div>

                                                <div class="col-sm-4 mt-3">
                                                    <p class="inv-email-address"> @lang('site.supplier') :    {{ $row->supplier->company_name }}</p>
                                                    <p class="inv-email-address"> @lang('site.email') :    {{ $row->supplier->email }} </p>
                                                    <p class="inv-email-address"> @lang('site.address') :    {{ $row->supplier->address }} </p>
                                                    <p class="inv-email-address"> @lang('site.phone') :    {{ $row->supplier->phone }} </p>
                                                </div>
