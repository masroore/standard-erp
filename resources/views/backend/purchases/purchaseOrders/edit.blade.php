...
@section('title')
       @lang('site.edit_purchase_orders')
@endsection
@section('modelTitlie')
...
@component('backend.partials._pagebar')
    ...
    <li class="breadcrumb-item active" aria-current="page"><span>@lang('site.edit_purchase_orders')</span></li>
            ...
            <div class="row">
                <div class="col-xl-12">
                    ...
                    <div class="invoice-content">
                        ...
                        <form id="form" name="requisitions" action="{{ route('dashboard.purchase-orders.update',$row->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('put')
                            <div class="invoice-detail-body">
                                @include('backend.purchases.purchaseOrders.editform')
                                <hr>
