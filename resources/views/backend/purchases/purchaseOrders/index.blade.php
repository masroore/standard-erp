...
@component('backend.partials._pagebar')
    ...
    <li class="breadcrumb-item"><a href="javascript:void(0);">  @lang('site.purchase_orders')</a></li>
    <li class="breadcrumb-item active" aria-current="page"><span>@lang('site.all_purchase_orders')</span></li>
                ...
                <div class="widget-header">
                    <div class="row">
                        ...
                        <div class="col-xl-6 col-md-6 col-sm-6 col-6 pt-2">
                            <a href="{{ route('dashboard.purchase-orders.create') }}" class="btn btn-primary float-right mr-5"> <i class="fa fa-plus" aria-hidden="true"></i> @lang('site.add_new') </a>
                        </div>
                    </div>
                </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="{{ route('dashboard.purchase-orders.show',$row->id ) }}" class="mr-2  text-info " title="@lang('site.show')"><i class="fa fa-eye fa-2x" aria-hidden="true"></i></a>
                            <a href="{{ route('dashboard.purchase-orders.edit',$row->id ) }}" class="mr-2  text-warning " title="@lang('site.edit')"><i class="fa fa-edit fa-2x" aria-hidden="true"></i></a>
                            @if ($row->document != null)
                            <a href="{{ asset('public/uploads/purchases/po/'.$row->document) }}" class="mr-2 text-primary " title="@lang('site.download')" download=""><i class="fa fa-file fa-2x" aria-hidden="true"></i></a>
                            @endif

                            <form action="{{route('dashboard.purchase-orders.destroy', $row->id)}}" method="POST" style="display:inline-block">
                                @csrf
                                @method('delete')
                                <a type="submit" class="mr-2  text-danger show_confirm" title="@lang('site.delete')"><i class="fa fa-trash fa-2x" aria-hidden="true"></i></a>
                            </form>
                        </td>
                    </tr>
