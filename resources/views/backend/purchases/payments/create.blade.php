...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            ...
            <form action="{{route('dashboard.purchases-payments.store')}}" method="POST" name="brand" enctype="multipart/form-data">
                @csrf
            ...
            <div class="modal-body">
                ...
                <div class="form-group col-md-4">
                    ...
                    <input type="hidden" name="purch_id" value="{{ $invoiceData->id }}">
                    <input type="hidden" name="supplier_id" value="{{ $invoiceData->supplier_id }}">
