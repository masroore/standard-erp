...
@include('backend.customerGroup.create')
                    ...
                    <tr>
                        ...
                        <td class="sorting_1 sorting_2">
                            <div class="d-flex">
                                ...
                                <p class="align-self-center mb-0 admin-name"> {{$row->percent}} </p>
                            </div>
                        </td>
                        ...
                        <td>
                              ...
                              @include('backend.customerGroup.edit')


                                <form action="{{route('dashboard.customerGroup.destroy', $row->id)}}" method="POST" style="display:inline-block">
                                    @csrf
                                 @method('delete')
