            ...
            <div class="widget-content widget-content-area">
                <nav class="breadcrumb-one p-3" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><span>@lang('site.list_roles')</span></li>
...
<div class="row layout-top-spacing" id="cancel-row">
    ...
    <div class="col-md-2">
        <a href="{{route('dashboard.roles.create')}}" class="btn btn-primary center">@lang('site.add_new_role')</a>
    </div>
