                    ...
                    <div class="col-lg-12">
                        <nav class="navbar navbar-expand-lg">
                            <a class="navbar-brand" href="#">
                                <h2 style="color: orangered">E.R.P</h2>
                                {{--  <img src="{{ asset('public/frontend/assets/images/logo.svg') }}" alt="Logo">  --}}
                            </a>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        <div class="header-hero-content text-center">
                            <h3 class="header-sub-title wow fadeInUp" data-wow-duration="1.3s" data-wow-delay="0.2s">Checkliat - SaaS Landing Page</h3>
                ...
                <div class="col-lg-12">
                    <div class="brand-logo d-flex align-items-center justify-content-center justify-content-md-between">
                        <div class="single-logo mt-30 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s">
                            <img src="{{ asset('public/frontend/assets/images/brand-1.png') }}" alt="brand">
                        </div> <!-- single logo -->
                        <div class="single-logo mt-30 wow fadeIn" data-wow-duration="1.5s" data-wow-delay="0.2s">
                            <img src="{{ asset('public/frontend/assets/images/brand-2.png') }}" alt="brand">
                        </div> <!-- single logo -->
                        <div class="single-logo mt-30 wow fadeIn" data-wow-duration="1.5s" data-wow-delay="0.3s">
                            <img src="{{ asset('public/frontend/assets/images/brand-3.png') }}" alt="brand">
                        </div> <!-- single logo -->
                        <div class="single-logo mt-30 wow fadeIn" data-wow-duration="1.5s" data-wow-delay="0.4s">
                            <img src="{{ asset('public/frontend/assets/images/brand-4.png') }}" alt="brand">
                        </div> <!-- single logo -->
                        <div class="single-logo mt-30 wow fadeIn" data-wow-duration="1.5s" data-wow-delay="0.5s">
                            <img src="{{ asset('public/frontend/assets/images/brand-5.png') }}" alt="brand">
                        </div> <!-- single logo -->
                    </div> <!-- brand logo -->
                </div>
            </div>   <!-- row -->
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-7 col-sm-8">
                    <div class="single-services text-center mt-30 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s">
                        <div class="services-icon">
                            <img class="shape" src="{{ asset('public/frontend/assets/images/services-shape.svg') }}" alt="shape">
                            <img class="shape-1" src="{{ asset('public/frontend/assets/images/services-shape-1.svg') }}" alt="shape">
                ...
                <div class="col-lg-4 col-md-7 col-sm-8">
                    <div class="single-services text-center mt-30 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.5s">
                        <div class="services-icon">
                            <img class="shape" src="{{ asset('public/frontend/assets/images/services-shape.svg') }}" alt="shape">
                            <img class="shape-1" src="{{ asset('public/frontend/assets/images/services-shape-2.svg') }}" alt="shape">
                ...
                <div class="col-lg-4 col-md-7 col-sm-8">
                    <div class="single-services text-center mt-30 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.8s">
                        <div class="services-icon">
                            <img class="shape" src="{{ asset('public/frontend/assets/images/services-shape.svg') }}" alt="shape">
                            <img class="shape-1" src="{{ asset('public/frontend/assets/images/services-shape-3.svg') }}" alt="shape">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="about-image text-center mt-50 wow fadeInRightBig" data-wow-duration="1s" data-wow-delay="0.5s">
                        <img src="{{ asset('public/frontend/assets/images/about1.svg') }}" alt="about">
                    </div> <!-- about image -->
                </div>
            </div> <!-- row -->
        </div> <!-- container -->
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 order-lg-first">
                    <div class="about-image text-center mt-50 wow fadeInRightBig" data-wow-duration="1s" data-wow-delay="0.5s">
                        <img src="{{ asset('public/frontend/assets/images/about2.svg') }}" alt="about">
                    </div> <!-- about image -->
                </div>
            </div> <!-- row -->
        </div> <!-- container -->
    ...
    <section class="about-area pt-70">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="about-image text-center mt-50 wow fadeInRightBig" data-wow-duration="1s" data-wow-delay="0.5s">
                        <img src="{{ asset('public/frontend/assets/images/about3.svg') }}" alt="about">
                    </div> <!-- about image -->
                </div>
            </div> <!-- row -->
        </div> <!-- container -->
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="video-content mt-50 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.5s">
                        <img class="dots" src="{{ asset('public/frontend/assets/images/dots.svg') }}" alt="dots">
                        <div class="video-wrapper">
                            <div class="video-image">
                                <img src="{{ asset('public/frontend/assets/images/video.png') }}" alt="video">
                            </div>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-8">
                        <div class="footer-about mt-50 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s">
                            <a class="logo" href="#">
                                 <h1 style="color: #fff">Checklist</h1>
                                {{--  <img src="{{ asset('public/frontend/assets/images/logo.svg') }}" alt="logo">  --}}
                            </a>
                    ...
                    <div class="col-lg-3 col-md-5 col-sm-5">
                        <div class="footer-contact mt-50 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.8s">
                            ...
                            <ul class="contact">
                                ...
                                <li>123 Stree 10th of Ramdan  <br> States Of B3 .</li>
                            </ul>
                        </div> <!-- footer contact -->
                    </div>
                </div> <!-- row -->
