        ...
        <ul class="navbar-item flex-row navbar-dropdown">
            <li class="nav-item dropdown language-dropdown more-dropdown">
                <div class="dropdown  custom-dropdown-icon">
                    <a class="dropdown-toggle btn" href="#" role="button" id="customDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> @if($current_lang == 'ar') <img src="{{asset('public/backend/crock//assets/img/158-egypt.svg')}}"class="flag-width" alt="flag"> @else <img src="{{asset('public/backend/crock//assets/img/flag-us.svg')}}" class="flag-width" alt="flag"> @endif <span>{{ LaravelLocalization::getCurrentLocaleNative() }}</span> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-down"><polyline points="6 9 12 15 18 9"></polyline></svg></a>
